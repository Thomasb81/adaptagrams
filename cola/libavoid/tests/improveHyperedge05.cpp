...
void test()
{
	...
	ConnRef::createConnRef(router0, end1_0, end2_0, 70922320).get();
	end1_0 = ConnEnd(junction0_185122667);
	end2_0 = ConnEnd(shape0_68611488, 2);
	ConnRef::createConnRef(router0, end1_0, end2_0, 141698060).get();
	end1_0 = ConnEnd(shape0_170757006, 1);
	end2_0 = ConnEnd(junction0_185122667);
	ConnRef::createConnRef(router0, end1_0, end2_0, 27983869).get();
	end1_0 = ConnEnd(shape0_300278382, 2);
	end2_0 = ConnEnd(junction0_185122667);
	ConnRef::createConnRef(router0, end1_0, end2_0, 197910572).get();
	router0->processTransaction();
