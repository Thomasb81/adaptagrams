...
void test()
{
	...
	auto  shape0_68611488 = ShapeRef::createShapeRef(router0, poly0, 68611488);
	auto pin0_68611488_0 = shape0_68611488->createConnectionPin(1, 0.810810810811, 0.0454545454545, true, 10, 1);
	pin0_68611488_0->setExclusive(true);
	auto pin0_68611488_1 = shape0_68611488->createConnectionPin(2, 0, 0.5, true, 10, 4);
	pin0_68611488_1->setExclusive(true);
	auto pin0_68611488_2 = shape0_68611488->createConnectionPin(3, 0.810810810811, 0.954545454545, true, 10, 2);
	...
	auto  shape0_84988680 = ShapeRef::createShapeRef(router0, poly0, 84988680);
	auto pin0_84988680_0 = shape0_84988680->createConnectionPin(1, 0.0625, 0.5, true, 10, 4);
	pin0_84988680_0->setExclusive(true);
	auto pin0_84988680_1 = shape0_84988680->createConnectionPin(2, 1, 0.5, true, 10, 8);
	...
	auto  shape0_170757006 = ShapeRef::createShapeRef(router0, poly0, 170757006);
	auto pin0_170757006_0 = shape0_170757006->createConnectionPin(1, 0.5, 1, true, 10, 2);
	pin0_170757006_0->setExclusive(true);
	auto pin0_170757006_1 = shape0_170757006->createConnectionPin(2, 0.5, 0.0625, true, 10, 1);
	pin0_170757006_1->setExclusive(true);
	auto  junction0_185122667 = JunctionRef::createJunctionRef(router0, Point(51675, 50825), 185122667);
	poly0 = Polygon(4);
	...
	auto  shape0_300278382 = ShapeRef::createShapeRef(router0, poly0, 300278382);
	auto pin0_300278382_0 = shape0_300278382->createConnectionPin(1, 0.5, 0.9375, true, 10, 2);
	pin0_300278382_0->setExclusive(true);
	auto pin0_300278382_1 = shape0_300278382->createConnectionPin(2, 0.5, 0, true, 10, 1);
	pin0_300278382_1->setExclusive(true);
	end1_0 = ConnEnd(shape0_84988680, 2);
	end2_0 = ConnEnd(junction0_185122667);
	ConnRef::createConnRef(router0, end1_0, end2_0, 70922320);
	end1_0 = ConnEnd(junction0_185122667);
	end2_0 = ConnEnd(shape0_68611488, 2);
	ConnRef::createConnRef(router0, end1_0, end2_0, 141698060);
	end1_0 = ConnEnd(shape0_170757006, 1);
	end2_0 = ConnEnd(junction0_185122667);
	ConnRef::createConnRef(router0, end1_0, end2_0, 27983869);
	end1_0 = ConnEnd(shape0_300278382, 2);
	end2_0 = ConnEnd(junction0_185122667);
	ConnRef::createConnRef(router0, end1_0, end2_0, 197910572);
	router0->processTransaction();
	...
	auto junction0_436653030 = *junctionit_0;
	...
	ConnRef * conn0_400977693 = (*connit_0).get();
