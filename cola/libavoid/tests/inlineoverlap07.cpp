...
int main(void) {
    ...
    auto connRef562170592 = ConnRef::createConnRef(router, 562170592);
    ...
    auto connRef171593006 = ConnRef::createConnRef(router, 171593006);
    ...
    auto connRef172593160 = ConnRef::createConnRef(router, 172593160);
    ...
    auto connRef116944564 = ConnRef::createConnRef(router, 116944564);
