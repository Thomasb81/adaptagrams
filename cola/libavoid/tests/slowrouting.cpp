...
auto junctionRef1634752 = JunctionRef::createJunctionRef(router, Point(24800, 27000), 1634752);
    ...
    ShapeRef::createShapeRef(router, poly2807970, 2807970);

auto junctionRef5416208 = JunctionRef::createJunctionRef(router, Point(24300, 28050), 5416208);
    ...
    ShapeRef::createShapeRef(router, poly8864520, 8864520);

auto junctionRef9420650 = JunctionRef::createJunctionRef(router, Point(26675, 28125), 9420650);
    ...
    ShapeRef::createShapeRef(router, poly11441468, 11441468);

auto junctionRef12650756 = JunctionRef::createJunctionRef(router, Point(24250, 26575), 12650756);
    ...
    ShapeRef::createShapeRef(router, poly13550052, 13550052);

auto junctionRef16613420 = JunctionRef::createJunctionRef(router, Point(27625, 28750), 16613420);
    ...
    ShapeRef::createShapeRef(router, poly16932600, 16932600);
    ...
    ShapeRef::createShapeRef(router, poly17785779, 17785779);

auto junctionRef23132835 = JunctionRef::createJunctionRef(router, Point(24450, 26900), 23132835);

auto junctionRef26572870 = JunctionRef::createJunctionRef(router, Point(23158, 26550), 26572870);
    ...
    ShapeRef::createShapeRef(router, poly27045198, 27045198);
    ...
    ShapeRef::createShapeRef(router, poly28607408, 28607408);
    ...
    ShapeRef::createShapeRef(router, poly28892384, 28892384);

auto junctionRef34620300 = JunctionRef::createJunctionRef(router, Point(24400, 26200), 34620300);

auto junctionRef36814260 = JunctionRef::createJunctionRef(router, Point(24994, 28975), 36814260);

auto junctionRef39695669 = JunctionRef::createJunctionRef(router, Point(24000, 29000), 39695669);
    ...
    ShapeRef::createShapeRef(router, poly39757638, 39757638);

auto junctionRef41941580 = JunctionRef::createJunctionRef(router, Point(23275, 26700), 41941580);
    ...
    ShapeRef::createShapeRef(router, poly44086980, 44086980);
    ...
    ShapeRef::createShapeRef(router, poly45299820, 45299820);
    ...
    ShapeRef::createShapeRef(router, poly45389694, 45389694);
    ...
    ShapeRef::createShapeRef(router, poly53329545, 53329545);

auto junctionRef58465624 = JunctionRef::createJunctionRef(router, Point(23200, 28550), 58465624);
    ...
    ShapeRef::createShapeRef(router, poly59167974, 59167974);
    ...
    ShapeRef::createShapeRef(router, poly66193481, 66193481);
    ...
    ShapeRef::createShapeRef(router, poly70299198, 70299198);
    ...
    ShapeRef::createShapeRef(router, poly71509898, 71509898);
    ...
    ShapeRef::createShapeRef(router, poly92664994, 92664994);
    ...
    ShapeRef::createShapeRef(router, poly106612990, 106612990);
    ...
    ShapeRef::createShapeRef(router, poly115549720, 115549720);

auto junctionRef117582414 = JunctionRef::createJunctionRef(router, Point(24225, 26700), 117582414);
    ...
    ShapeRef::createShapeRef(router, poly129015449, 129015449);

auto junctionRef131744632 = JunctionRef::createJunctionRef(router, Point(24870, 26650), 131744632);
    ...
    ShapeRef::createShapeRef(router, poly132843360, 132843360);

auto junctionRef137263932 = JunctionRef::createJunctionRef(router, Point(24250, 27125), 137263932);

auto junctionRef137883060 = JunctionRef::createJunctionRef(router, Point(25000, 28650), 137883060);

auto junctionRef144791664 = JunctionRef::createJunctionRef(router, Point(24300, 29050), 144791664);

auto junctionRef147481188 = JunctionRef::createJunctionRef(router, Point(23208, 28075), 147481188);
    ...
    ShapeRef::createShapeRef(router, poly156912624, 156912624);
    ...
    ShapeRef::createShapeRef(router, poly163577296, 163577296);
    ...
    ShapeRef::createShapeRef(router, poly165702672, 165702672);
    ...
    ShapeRef::createShapeRef(router, poly165841098, 165841098);
    ...
    ShapeRef::createShapeRef(router, poly170549060, 170549060);
    ...
    ShapeRef::createShapeRef(router, poly188773123, 188773123);
    ...
    ShapeRef::createShapeRef(router, poly190710960, 190710960);

auto junctionRef195377532 = JunctionRef::createJunctionRef(router, Point(27425, 27650), 195377532);

auto junctionRef200348672 = JunctionRef::createJunctionRef(router, Point(27564, 28000), 200348672);
    ...
    ShapeRef::createShapeRef(router, poly200595752, 200595752);
    ...
    ShapeRef::createShapeRef(router, poly208373760, 208373760);
    ...
    ShapeRef::createShapeRef(router, poly208442016, 208442016);
    ...
    ShapeRef::createShapeRef(router, poly214671138, 214671138);
    ...
    ShapeRef::createShapeRef(router, poly215949184, 215949184);

auto junctionRef221746560 = JunctionRef::createJunctionRef(router, Point(26702, 28825), 221746560);
    ...
    ShapeRef::createShapeRef(router, poly221761830, 221761830);
    ...
    ShapeRef::createShapeRef(router, poly226135532, 226135532);

auto junctionRef228740625 = JunctionRef::createJunctionRef(router, Point(24350, 29300), 228740625);
    ...
    ShapeRef::createShapeRef(router, poly251291208, 251291208);

auto junctionRef255105144 = JunctionRef::createJunctionRef(router, Point(26700, 28425), 255105144);

auto junctionRef275948952 = JunctionRef::createJunctionRef(router, Point(23281, 27100), 275948952);
    ...
    ShapeRef::createShapeRef(router, poly292681455, 292681455);

auto junctionRef295885488 = JunctionRef::createJunctionRef(router, Point(23925, 26625), 295885488);

auto junctionRef299817832 = JunctionRef::createJunctionRef(router, Point(24300, 27500), 299817832);

auto junctionRef309723792 = JunctionRef::createJunctionRef(router, Point(23575, 26100), 309723792);
    ...
    ShapeRef::createShapeRef(router, poly312169746, 312169746);
    ...
    ShapeRef::createShapeRef(router, poly324370200, 324370200);
    ...
    ShapeRef::createShapeRef(router, poly330285180, 330285180);
    ...
    ShapeRef::createShapeRef(router, poly343901696, 343901696);

auto junctionRef350832579 = JunctionRef::createJunctionRef(router, Point(25000, 28450), 350832579);
    ...
    ShapeRef::createShapeRef(router, poly351751345, 351751345);

auto junctionRef358449734 = JunctionRef::createJunctionRef(router, Point(27616, 29175), 358449734);

auto junctionRef373450980 = JunctionRef::createJunctionRef(router, Point(27525, 27250), 373450980);

auto junctionRef391945245 = JunctionRef::createJunctionRef(router, Point(27500, 28350), 391945245);

auto junctionRef394539723 = JunctionRef::createJunctionRef(router, Point(23550, 26350), 394539723);
    ...
    ShapeRef::createShapeRef(router, poly396658490, 396658490);
    ...
    ShapeRef::createShapeRef(router, poly408762900, 408762900);

auto junctionRef414982287 = JunctionRef::createJunctionRef(router, Point(24406, 26100), 414982287);
    ...
    ShapeRef::createShapeRef(router, poly486383940, 486383940);

auto junctionRef495386613 = JunctionRef::createJunctionRef(router, Point(23200, 29075), 495386613);

auto junctionRef504671094 = JunctionRef::createJunctionRef(router, Point(24836, 27425), 504671094);

auto junctionRef557043721 = JunctionRef::createJunctionRef(router, Point(26702, 29250), 557043721);

auto junctionRef619528800 = JunctionRef::createJunctionRef(router, Point(24168, 28425), 619528800);
    ...
    ShapeRef::createShapeRef(router, poly627663896, 627663896);

auto junctionRef639333280 = JunctionRef::createJunctionRef(router, Point(24000, 26450), 639333280);

auto junctionRef706194558 = JunctionRef::createJunctionRef(router, Point(24300, 28550), 706194558);
    ...
    ShapeRef::createShapeRef(router, poly735238470, 735238470);

auto junctionRef736226792 = JunctionRef::createJunctionRef(router, Point(23150, 29350), 736226792);
    ...
    ShapeRef::createShapeRef(router, poly736682544, 736682544);
    ...
    ShapeRef::createShapeRef(router, poly760051248, 760051248);

auto junctionRef790438915 = JunctionRef::createJunctionRef(router, Point(24075, 28500), 790438915);

auto junctionRef881601350 = JunctionRef::createJunctionRef(router, Point(27692, 29100), 881601350);
    ...
    ShapeRef::createShapeRef(router, poly900057885, 900057885);

auto junctionRef990913310 = JunctionRef::createJunctionRef(router, Point(24000, 27025), 990913310);

    ConnRef *connRef2650284 = ConnRef::createConnRef(router, 2650284).get();
    ...
    ConnRef *connRef2833330 = ConnRef::createConnRef(router, 2833330).get();
    ...
    ConnRef *connRef4043718 = ConnRef::createConnRef(router, 4043718).get();
    ...
    ConnRef *connRef9745060 = ConnRef::createConnRef(router, 9745060).get();
    ...
    ConnRef *connRef10983140 = ConnRef::createConnRef(router, 10983140).get();
    ...
    ConnRef *connRef11588500 = ConnRef::createConnRef(router, 11588500).get();
    ...
    ConnRef *connRef11844992 = ConnRef::createConnRef(router, 11844992).get();
    ...
    ConnRef *connRef14786845 = ConnRef::createConnRef(router, 14786845).get();
    ...
    ConnRef *connRef16261480 = ConnRef::createConnRef(router, 16261480).get();
    ...
    ConnRef *connRef16390046 = ConnRef::createConnRef(router, 16390046).get();
    ...
    ConnRef *connRef17931396 = ConnRef::createConnRef(router, 17931396).get();
    ...
    ConnRef *connRef22109256 = ConnRef::createConnRef(router, 22109256).get();
    ...
    ConnRef *connRef22594350 = ConnRef::createConnRef(router, 22594350).get();
    ...
    ConnRef *connRef22914582 = ConnRef::createConnRef(router, 22914582).get();
    ...
    ConnRef *connRef23169708 = ConnRef::createConnRef(router, 23169708).get();
    ...
    ConnRef *connRef23586424 = ConnRef::createConnRef(router, 23586424).get();
    ...
    ConnRef *connRef24487272 = ConnRef::createConnRef(router, 24487272).get();
    ...
    ConnRef *connRef26971490 = ConnRef::createConnRef(router, 26971490).get();
    ...
    ConnRef *connRef27342336 = ConnRef::createConnRef(router, 27342336).get();
    ...
    ConnRef *connRef29036799 = ConnRef::createConnRef(router, 29036799).get();
    ...
    ConnRef *connRef29965772 = ConnRef::createConnRef(router, 29965772).get();
    ...
    ConnRef *connRef31188915 = ConnRef::createConnRef(router, 31188915).get();
    ...
    ConnRef *connRef32390545 = ConnRef::createConnRef(router, 32390545).get();
    ...
    ConnRef *connRef33457066 = ConnRef::createConnRef(router, 33457066).get();
    ...
    ConnRef *connRef34908836 = ConnRef::createConnRef(router, 34908836).get();
    ...
    ConnRef *connRef37638287 = ConnRef::createConnRef(router, 37638287).get();
    ...
    ConnRef *connRef40448457 = ConnRef::createConnRef(router, 40448457).get();
    ...
    ConnRef *connRef40882634 = ConnRef::createConnRef(router, 40882634).get();
    ...
    ConnRef *connRef47717100 = ConnRef::createConnRef(router, 47717100).get();
    ...
    ConnRef *connRef56597370 = ConnRef::createConnRef(router, 56597370).get();
    ...
    ConnRef *connRef59354933 = ConnRef::createConnRef(router, 59354933).get();
    ...
    ConnRef *connRef77227284 = ConnRef::createConnRef(router, 77227284).get();
    ...
    ConnRef *connRef79612408 = ConnRef::createConnRef(router, 79612408).get();
    ...
    ConnRef *connRef82780868 = ConnRef::createConnRef(router, 82780868).get();
    ...
    ConnRef *connRef83092945 = ConnRef::createConnRef(router, 83092945).get();
    ...
    ConnRef *connRef88266240 = ConnRef::createConnRef(router, 88266240).get();
    ...
    ConnRef *connRef90460104 = ConnRef::createConnRef(router, 90460104).get();
    ...
    ConnRef *connRef91952388 = ConnRef::createConnRef(router, 91952388).get();
    ...
    ConnRef *connRef92256651 = ConnRef::createConnRef(router, 92256651).get();
    ...
    ConnRef *connRef95273991 = ConnRef::createConnRef(router, 95273991).get();
    ...
    ConnRef *connRef98351958 = ConnRef::createConnRef(router, 98351958).get();
    ...
    ConnRef *connRef101848175 = ConnRef::createConnRef(router, 101848175).get();
    ...
    ConnRef *connRef107055166 = ConnRef::createConnRef(router, 107055166).get();
    ...
    ConnRef *connRef126287880 = ConnRef::createConnRef(router, 126287880).get();
    ...
    ConnRef *connRef149791360 = ConnRef::createConnRef(router, 149791360).get();
    ...
    ConnRef *connRef152838249 = ConnRef::createConnRef(router, 152838249).get();
    ...
    ConnRef *connRef156657228 = ConnRef::createConnRef(router, 156657228).get();
    ...
    ConnRef *connRef157276356 = ConnRef::createConnRef(router, 157276356).get();
    ...
    ConnRef *connRef162858434 = ConnRef::createConnRef(router, 162858434).get();
    ...
    ConnRef *connRef170639469 = ConnRef::createConnRef(router, 170639469).get();
    ...
    ConnRef *connRef171917628 = ConnRef::createConnRef(router, 171917628).get();
    ...
    ConnRef *connRef175703112 = ConnRef::createConnRef(router, 175703112).get();
    ...
    ConnRef *connRef175774395 = ConnRef::createConnRef(router, 175774395).get();
    ...
    ConnRef *connRef177387840 = ConnRef::createConnRef(router, 177387840).get();
    ...
    ConnRef *connRef179014612 = ConnRef::createConnRef(router, 179014612).get();
    ...
    ConnRef *connRef181436988 = ConnRef::createConnRef(router, 181436988).get();
    ...
    ConnRef *connRef186910820 = ConnRef::createConnRef(router, 186910820).get();
    ...
    ConnRef *connRef187785156 = ConnRef::createConnRef(router, 187785156).get();
    ...
    ConnRef *connRef189722660 = ConnRef::createConnRef(router, 189722660).get();
    ...
    ConnRef *connRef192744750 = ConnRef::createConnRef(router, 192744750).get();
    ...
    ConnRef *connRef197632590 = ConnRef::createConnRef(router, 197632590).get();
    ...
    ConnRef *connRef199761771 = ConnRef::createConnRef(router, 199761771).get();
    ...
    ConnRef *connRef200371408 = ConnRef::createConnRef(router, 200371408).get();
    ...
    ConnRef *connRef202197435 = ConnRef::createConnRef(router, 202197435).get();
    ...
    ConnRef *connRef223350000 = ConnRef::createConnRef(router, 223350000).get();
    ...
    ConnRef *connRef225755952 = ConnRef::createConnRef(router, 225755952).get();
    ...
    ConnRef *connRef231794598 = ConnRef::createConnRef(router, 231794598).get();
    ...
    ConnRef *connRef235948750 = ConnRef::createConnRef(router, 235948750).get();
    ...
    ConnRef *connRef237307070 = ConnRef::createConnRef(router, 237307070).get();
    ...
    ConnRef *connRef243434688 = ConnRef::createConnRef(router, 243434688).get();
    ...
    ConnRef *connRef257379648 = ConnRef::createConnRef(router, 257379648).get();
    ...
    ConnRef *connRef257846316 = ConnRef::createConnRef(router, 257846316).get();
    ...
    ConnRef *connRef258773320 = ConnRef::createConnRef(router, 258773320).get();
    ...
    ConnRef *connRef260211707 = ConnRef::createConnRef(router, 260211707).get();
    ...
    ConnRef *connRef273011160 = ConnRef::createConnRef(router, 273011160).get();
    ...
    ConnRef *connRef274013534 = ConnRef::createConnRef(router, 274013534).get();
    ...
    ConnRef *connRef279737601 = ConnRef::createConnRef(router, 279737601).get();
    ...
    ConnRef *connRef281388594 = ConnRef::createConnRef(router, 281388594).get();
    ...
    ConnRef *connRef285908400 = ConnRef::createConnRef(router, 285908400).get();
    ...
    ConnRef *connRef287034425 = ConnRef::createConnRef(router, 287034425).get();
    ...
    ConnRef *connRef288108606 = ConnRef::createConnRef(router, 288108606).get();
    ...
    ConnRef *connRef290380424 = ConnRef::createConnRef(router, 290380424).get();
    ...
    ConnRef *connRef294588780 = ConnRef::createConnRef(router, 294588780).get();
    ...
    ConnRef *connRef295795481 = ConnRef::createConnRef(router, 295795481).get();
    ...
    ConnRef *connRef297813338 = ConnRef::createConnRef(router, 297813338).get();
    ...
    ConnRef *connRef297831780 = ConnRef::createConnRef(router, 297831780).get();
    ...
    ConnRef *connRef305590064 = ConnRef::createConnRef(router, 305590064).get();
    ...
    ConnRef *connRef311241725 = ConnRef::createConnRef(router, 311241725).get();
    ...
    ConnRef *connRef322174720 = ConnRef::createConnRef(router, 322174720).get();
    ...
    ConnRef *connRef322291528 = ConnRef::createConnRef(router, 322291528).get();
    ...
    ConnRef *connRef328813520 = ConnRef::createConnRef(router, 328813520).get();
    ...
    ConnRef *connRef342417330 = ConnRef::createConnRef(router, 342417330).get();
    ...
    ConnRef *connRef351151744 = ConnRef::createConnRef(router, 351151744).get();
    ...
    ConnRef *connRef353764215 = ConnRef::createConnRef(router, 353764215).get();
    ...
    ConnRef *connRef360051452 = ConnRef::createConnRef(router, 360051452).get();
    ...
    ConnRef *connRef370001467 = ConnRef::createConnRef(router, 370001467).get();
    ...
    ConnRef *connRef374482680 = ConnRef::createConnRef(router, 374482680).get();
    ...
    ConnRef *connRef384565632 = ConnRef::createConnRef(router, 384565632).get();
    ...
    ConnRef *connRef385394335 = ConnRef::createConnRef(router, 385394335).get();
    ...
    ConnRef *connRef394841184 = ConnRef::createConnRef(router, 394841184).get();
    ...
    ConnRef *connRef395684456 = ConnRef::createConnRef(router, 395684456).get();
    ...
    ConnRef *connRef399195680 = ConnRef::createConnRef(router, 399195680).get();
    ...
    ConnRef *connRef430804024 = ConnRef::createConnRef(router, 430804024).get();
    ...
    ConnRef *connRef441263950 = ConnRef::createConnRef(router, 441263950).get();
    ...
    ConnRef *connRef449028114 = ConnRef::createConnRef(router, 449028114).get();
    ...
    ConnRef *connRef456315054 = ConnRef::createConnRef(router, 456315054).get();
    ...
    ConnRef *connRef463648203 = ConnRef::createConnRef(router, 463648203).get();
    ...
    ConnRef *connRef466988995 = ConnRef::createConnRef(router, 466988995).get();
    ...
    ConnRef *connRef470918448 = ConnRef::createConnRef(router, 470918448).get();
    ...
    ConnRef *connRef473830263 = ConnRef::createConnRef(router, 473830263).get();
    ...
    ConnRef *connRef475132644 = ConnRef::createConnRef(router, 475132644).get();
    ...
    ConnRef *connRef482803577 = ConnRef::createConnRef(router, 482803577).get();
    ...
    ConnRef *connRef485259659 = ConnRef::createConnRef(router, 485259659).get();
    ...
    ConnRef *connRef489175830 = ConnRef::createConnRef(router, 489175830).get();
    ...
    ConnRef *connRef491853546 = ConnRef::createConnRef(router, 491853546).get();
    ...
    ConnRef *connRef493768530 = ConnRef::createConnRef(router, 493768530).get();
    ...
    ConnRef *connRef545608051 = ConnRef::createConnRef(router, 545608051).get();
    ...
    ConnRef *connRef553412832 = ConnRef::createConnRef(router, 553412832).get();
    ...
    ConnRef *connRef561568812 = ConnRef::createConnRef(router, 561568812).get();
    ...
    ConnRef *connRef567114946 = ConnRef::createConnRef(router, 567114946).get();
    ...
    ConnRef *connRef568675195 = ConnRef::createConnRef(router, 568675195).get();
    ...
    ConnRef *connRef578029290 = ConnRef::createConnRef(router, 578029290).get();
    ...
    ConnRef *connRef580228904 = ConnRef::createConnRef(router, 580228904).get();
    ...
    ConnRef *connRef591782037 = ConnRef::createConnRef(router, 591782037).get();
    ...
    ConnRef *connRef592807451 = ConnRef::createConnRef(router, 592807451).get();
    ...
    ConnRef *connRef594396814 = ConnRef::createConnRef(router, 594396814).get();
    ...
    ConnRef *connRef599540824 = ConnRef::createConnRef(router, 599540824).get();
    ...
    ConnRef *connRef603411683 = ConnRef::createConnRef(router, 603411683).get();
    ...
    ConnRef *connRef605752708 = ConnRef::createConnRef(router, 605752708).get();
    ...
    ConnRef *connRef606705960 = ConnRef::createConnRef(router, 606705960).get();
    ...
    ConnRef *connRef609832117 = ConnRef::createConnRef(router, 609832117).get();
    ...
    ConnRef *connRef621742890 = ConnRef::createConnRef(router, 621742890).get();
    ...
    ConnRef *connRef636523650 = ConnRef::createConnRef(router, 636523650).get();
    ...
    ConnRef *connRef642950671 = ConnRef::createConnRef(router, 642950671).get();
    ...
    ConnRef *connRef651115920 = ConnRef::createConnRef(router, 651115920).get();
    ...
    ConnRef *connRef671449520 = ConnRef::createConnRef(router, 671449520).get();
    ...
    ConnRef *connRef683989950 = ConnRef::createConnRef(router, 683989950).get();
    ...
    ConnRef *connRef906470916 = ConnRef::createConnRef(router, 906470916).get();
    ...
    ConnRef *connRef952154604 = ConnRef::createConnRef(router, 952154604).get();
    ...
    ConnRef *connRef952588978 = ConnRef::createConnRef(router, 952588978).get();
