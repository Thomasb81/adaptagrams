...
int main(void) {
    ...
    auto junction478845150 = JunctionRef::createJunctionRef(router, Point(50700, 51075));
    
    Rectangle rect92712048(Point(51246, 50475), Point(51304, 50585));
    ShapeRef::createShapeRef(router, rect92712048, 92712048);
    Rectangle rect23127921(Point(50365, 50766), Point(50485, 50834));
    ShapeRef::createShapeRef(router, rect23127921, 23127921);
    Rectangle rect159957148(Point(51740, 50891), Point(51860, 50959));
    ShapeRef::createShapeRef(router, rect159957148, 159957148);
    Rectangle rect1350214(Point(50375, 51015), Point(50625, 51135));
    ShapeRef::createShapeRef(router, rect1350214, 1350214);
    Rectangle rect247197258(Point(50265, 51046), Point(50375, 51104));
    ShapeRef::createShapeRef(router, rect247197258, 247197258);
    ...
    ConnRef::createConnRef(router, srcPt92802970, dstPt92802970, 92802970).get();
