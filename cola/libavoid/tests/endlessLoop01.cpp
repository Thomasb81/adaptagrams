...
void test()
{
	...
	router0->deleteConnector(conn0_92116728->getPtr());
	conn0_92116728 = nullptr;
	router0->deleteConnector(conn0_160581511->getPtr());
	conn0_160581511 = nullptr;
	router0->deleteConnector(conn0_17788857->getPtr());
	conn0_17788857 = nullptr;
	router0->deleteJunction(junction0_390996481);
	junction0_390996481 = nullptr;
	router0->deleteConnector(conn0_545568780->getPtr());
	conn0_545568780 = nullptr;
	router0->deleteConnector(conn0_175131537->getPtr());
	conn0_175131537 = nullptr;
	router0->deleteJunction(junction0_46074711);
	junction0_46074711 = nullptr;
	router0->deleteConnector(conn0_510680660->getPtr());
	conn0_510680660 = nullptr;
	router0->deleteConnector(conn0_627671070->getPtr());
	conn0_627671070 = nullptr;
	router0->deleteJunction(junction0_503331836);
	junction0_503331836 = nullptr;
	router0->deleteConnector(conn0_929108568->getPtr());
