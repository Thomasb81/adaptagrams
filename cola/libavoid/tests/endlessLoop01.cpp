...
void test()
{
	...
	auto  shape0_355243155 = ShapeRef::createShapeRef(router0, poly0, 355243155);
	auto pin0_355243155_0 = shape0_355243155->createConnectionPin(1, 1, 0.149122807018, true, 10, 8);
	pin0_355243155_0->setExclusive(true);
	auto pin0_355243155_1 = shape0_355243155->createConnectionPin(2, 1, 0.675438596491, true, 10, 8);
	pin0_355243155_1->setExclusive(true);
	auto pin0_355243155_2 = shape0_355243155->createConnectionPin(3, 1, 0.80701754386, true, 10, 8);
	pin0_355243155_2->setExclusive(true);
	auto pin0_355243155_3 = shape0_355243155->createConnectionPin(4, 1, 0.543859649123, true, 10, 8);
	pin0_355243155_3->setExclusive(true);
	auto pin0_355243155_4 = shape0_355243155->createConnectionPin(5, 1, 0.280701754386, true, 10, 8);
	pin0_355243155_4->setExclusive(true);
	auto pin0_355243155_5 = shape0_355243155->createConnectionPin(6, 1, 0.412280701754, true, 10, 8);
	pin0_355243155_5->setExclusive(true);
	auto pin0_355243155_6 = shape0_355243155->createConnectionPin(7, 0.477611940299, 0.982456140351, true, 10, 2);
	pin0_355243155_6->setExclusive(true);
	auto pin0_355243155_7 = shape0_355243155->createConnectionPin(8, 0.253731343284, 0.982456140351, true, 10, 2);
	...
	auto  shape0_35177560 = ShapeRef::createShapeRef(router0, poly0, 35177560);
	auto pin0_35177560_0 = shape0_35177560->createConnectionPin(1, 0.5, 0.5, true, 0, 15);
	...
	auto  shape0_214253640 = ShapeRef::createShapeRef(router0, poly0, 214253640);
	auto pin0_214253640_0 = shape0_214253640->createConnectionPin(1, 0.5, 0.5, true, 0, 15);
	pin0_214253640_0->setExclusive(true);
	auto  junction0_636368600 = JunctionRef::createJunctionRef(router0, Point(50875, 50850), 636368600);
	auto  junction0_503331836 = JunctionRef::createJunctionRef(router0, Point(50875, 51000), 503331836);
	auto  junction0_46074711 = JunctionRef::createJunctionRef(router0, Point(50775, 51000), 46074711);
	auto  junction0_390996481 = JunctionRef::createJunctionRef(router0, Point(50775, 50850), 390996481);
	end1_0 = ConnEnd(junction0_636368600);
	end2_0 = ConnEnd(shape0_35177560, 1);
	auto  conn0_929108568 = ConnRef::createConnRef(router0, end1_0, end2_0, 929108568);
	end1_0 = ConnEnd(junction0_503331836);
	end2_0 = ConnEnd(shape0_214253640, 1);
	auto  conn0_627671070 = ConnRef::createConnRef(router0, end1_0, end2_0, 627671070);
	end1_0 = ConnEnd(junction0_636368600);
	end2_0 = ConnEnd(junction0_503331836);
	auto  conn0_510680660 = ConnRef::createConnRef(router0, end1_0, end2_0, 510680660);
	end1_0 = ConnEnd(shape0_355243155, 2);
	end2_0 = ConnEnd(junction0_46074711);
	auto  conn0_175131537 = ConnRef::createConnRef(router0, end1_0, end2_0, 175131537);
	end1_0 = ConnEnd(junction0_46074711);
	end2_0 = ConnEnd(junction0_503331836);
	auto  conn0_545568780 = ConnRef::createConnRef(router0, end1_0, end2_0, 545568780);
	end1_0 = ConnEnd(shape0_355243155, 6);
	end2_0 = ConnEnd(junction0_390996481);
	auto  conn0_17788857 = ConnRef::createConnRef(router0, end1_0, end2_0, 17788857);
	end1_0 = ConnEnd(junction0_390996481);
	end2_0 = ConnEnd(junction0_636368600);
	auto  conn0_160581511 = ConnRef::createConnRef(router0, end1_0, end2_0, 160581511);
	end1_0 = ConnEnd(junction0_46074711);
	end2_0 = ConnEnd(junction0_390996481);
	auto  conn0_92116728 = ConnRef::createConnRef(router0, end1_0, end2_0, 92116728);
