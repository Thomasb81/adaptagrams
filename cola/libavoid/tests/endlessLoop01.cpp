...
void test()
{
	...
	ConnRef * conn0_929108568 = ConnRef::createConnRef(router0, end1_0, end2_0, 929108568).get();
	end1_0 = ConnEnd(junction0_503331836);
	end2_0 = ConnEnd(shape0_214253640, 1);
	ConnRef * conn0_627671070 = ConnRef::createConnRef(router0, end1_0, end2_0, 627671070).get();
	end1_0 = ConnEnd(junction0_636368600);
	end2_0 = ConnEnd(junction0_503331836);
	ConnRef * conn0_510680660 = ConnRef::createConnRef(router0, end1_0, end2_0, 510680660).get();
	end1_0 = ConnEnd(shape0_355243155, 2);
	end2_0 = ConnEnd(junction0_46074711);
	ConnRef * conn0_175131537 = ConnRef::createConnRef(router0, end1_0, end2_0, 175131537).get();
	end1_0 = ConnEnd(junction0_46074711);
	end2_0 = ConnEnd(junction0_503331836);
	ConnRef * conn0_545568780 = ConnRef::createConnRef(router0, end1_0, end2_0, 545568780).get();
	end1_0 = ConnEnd(shape0_355243155, 6);
	end2_0 = ConnEnd(junction0_390996481);
	ConnRef * conn0_17788857 = ConnRef::createConnRef(router0, end1_0, end2_0, 17788857).get();
	end1_0 = ConnEnd(junction0_390996481);
	end2_0 = ConnEnd(junction0_636368600);
	ConnRef * conn0_160581511 = ConnRef::createConnRef(router0, end1_0, end2_0, 160581511).get();
	end1_0 = ConnEnd(junction0_46074711);
	end2_0 = ConnEnd(junction0_390996481);
	ConnRef * conn0_92116728 = ConnRef::createConnRef(router0, end1_0, end2_0, 92116728).get();
	...
	router0->deleteConnector(conn0_92116728->getPtr()->getPtr());
	conn0_92116728 = nullptr;
	router0->deleteConnector(conn0_160581511->getPtr()->getPtr());
	conn0_160581511 = nullptr;
	router0->deleteConnector(conn0_17788857->getPtr()->getPtr());
	conn0_17788857 = nullptr;
	router0->deleteJunction(junction0_390996481);
	junction0_390996481 = nullptr;
	router0->deleteConnector(conn0_545568780->getPtr()->getPtr());
	conn0_545568780 = nullptr;
	router0->deleteConnector(conn0_175131537->getPtr()->getPtr());
	conn0_175131537 = nullptr;
	router0->deleteJunction(junction0_46074711);
	junction0_46074711 = nullptr;
	router0->deleteConnector(conn0_510680660->getPtr()->getPtr());
	conn0_510680660 = nullptr;
	router0->deleteConnector(conn0_627671070->getPtr()->getPtr());
	conn0_627671070 = nullptr;
	router0->deleteJunction(junction0_503331836);
	junction0_503331836 = nullptr;
	router0->deleteConnector(conn0_929108568->getPtr()->getPtr());
