...
int main(void) {
    ...
    auto connRef292408794 = ConnRef::createConnRef(router, 292408794);
    ...
    auto connRef40917776 = ConnRef::createConnRef(router, 40917776);
    ...
    auto connRef629564142 = ConnRef::createConnRef(router, 629564142);
