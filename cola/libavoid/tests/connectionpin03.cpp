...
int main(void) {
    ...
    shapeRef219926511->createConnectionPin(2147483646, 0.5, 0.5, true, 0, (ConnDirFlags) 4);
    shapeRef219926511->createConnectionPin(2147483646, 0.5, 0.5, true, 0, (ConnDirFlags) 1);
    shapeRef219926511->createConnectionPin(2147483646, 0.5, 0.5, true, 0, (ConnDirFlags) 8);
    shapeRef219926511->createConnectionPin(2147483646, 0.5, 0.5, true, 0, (ConnDirFlags) 2);
    ...
    shapeRef223927132->createConnectionPin(2147483646, 0.5, 0.5, true, 0, (ConnDirFlags) 4);
    shapeRef223927132->createConnectionPin(2147483646, 0.5, 0.5, true, 0, (ConnDirFlags) 1);
    shapeRef223927132->createConnectionPin(2147483646, 0.5, 0.5, true, 0, (ConnDirFlags) 8);
    shapeRef223927132->createConnectionPin(2147483646, 0.5, 0.5, true, 0, (ConnDirFlags) 2);
    ...
    auto connRef450684531 = ConnRef::createConnRef(router, 450684531);
    ...
    auto connRef135371350 = ConnRef::createConnRef(router, 135371350);
    ...
    auto connRef143333770 = ConnRef::createConnRef(router, 143333770);
    ...
    auto connRef102966575 = ConnRef::createConnRef(router, 102966575);
    ...
    auto connRef68998920 = ConnRef::createConnRef(router, 68998920);
    ...
    auto connRef1625709 = ConnRef::createConnRef(router, 1625709);
    ...
    auto connRef34178450 = ConnRef::createConnRef(router, 34178450);
    ...
    auto connRef7982176 = ConnRef::createConnRef(router, 7982176);
    ...
    auto connRef197177982 = ConnRef::createConnRef(router, 197177982);
    ...
    auto connRef398066432 = ConnRef::createConnRef(router, 398066432);
    ...
    auto connRef314512308 = ConnRef::createConnRef(router, 314512308);
    ...
    auto connRef182776308 = ConnRef::createConnRef(router, 182776308);
    ...
    auto connRef96504835 = ConnRef::createConnRef(router, 96504835);
    ...
    auto connRef118099300 = ConnRef::createConnRef(router, 118099300);
    ...
    auto connRef176080410 = ConnRef::createConnRef(router, 176080410);
    ...
    auto connRef426666001 = ConnRef::createConnRef(router, 426666001);
    ...
    auto connRef795762792 = ConnRef::createConnRef(router, 795762792);
    ...
    auto connRef467016913 = ConnRef::createConnRef(router, 467016913);
    ...
    auto connRef45740440 = ConnRef::createConnRef(router, 45740440);
    ...
    auto connRef985644192 = ConnRef::createConnRef(router, 985644192);
