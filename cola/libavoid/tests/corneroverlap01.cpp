...
int main(void) {
    ...
    ShapeRef::createShapeRef(router, poly21424960, 21424960);
    ...
    ShapeRef::createShapeRef(router, poly435105790, 435105790);
    ...
    ShapeRef::createShapeRef(router, poly40787191, 40787191);
    ...
    ShapeRef::createShapeRef(router, poly76911264, 76911264);
    ...
    ShapeRef::createShapeRef(router, poly506213376, 506213376);
    ...
    ShapeRef::createShapeRef(router, poly134604636, 134604636);
    ...
    ShapeRef::createShapeRef(router, poly14353632, 14353632);
    
    ConnRef *connRef70269732 = ConnRef::createConnRef(router, 70269732).get();
    ...
    ConnRef *connRef371572709 = ConnRef::createConnRef(router, 371572709).get();
    ...
    ConnRef *connRef876797766 = ConnRef::createConnRef(router, 876797766).get();
    ...
    ConnRef *connRef134423590 = ConnRef::createConnRef(router, 134423590).get();
    ...
    ConnRef *connRef872586669 = ConnRef::createConnRef(router, 872586669).get();
    ...
    ConnRef *connRef23601612 = ConnRef::createConnRef(router, 23601612).get();
    ...
    ConnRef *connRef737483980 = ConnRef::createConnRef(router, 737483980).get();
    ...
    ConnRef *connRef410784855 = ConnRef::createConnRef(router, 410784855).get();
    ...
    ConnRef *connRef15771480 = ConnRef::createConnRef(router, 15771480).get();
    ...
    ConnRef *connRef34657402 = ConnRef::createConnRef(router, 34657402).get();
    ...
    ConnRef *connRef98191218 = ConnRef::createConnRef(router, 98191218).get();
    ...
    ConnRef *connRef23433311 = ConnRef::createConnRef(router, 23433311).get();
