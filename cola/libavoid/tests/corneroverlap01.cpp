...
int main(void) {
    ...
    auto connRef70269732 = ConnRef::createConnRef(router, 70269732);
    ...
    auto connRef371572709 = ConnRef::createConnRef(router, 371572709);
    ...
    auto connRef876797766 = ConnRef::createConnRef(router, 876797766);
    ...
    auto connRef134423590 = ConnRef::createConnRef(router, 134423590);
    ...
    auto connRef872586669 = ConnRef::createConnRef(router, 872586669);
    ...
    auto connRef23601612 = ConnRef::createConnRef(router, 23601612);
    ...
    auto connRef737483980 = ConnRef::createConnRef(router, 737483980);
    ...
    auto connRef410784855 = ConnRef::createConnRef(router, 410784855);
    ...
    auto connRef15771480 = ConnRef::createConnRef(router, 15771480);
    ...
    auto connRef34657402 = ConnRef::createConnRef(router, 34657402);
    ...
    auto connRef98191218 = ConnRef::createConnRef(router, 98191218);
    ...
    auto connRef23433311 = ConnRef::createConnRef(router, 23433311);
