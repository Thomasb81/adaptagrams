...
int main(void) {
    ...
    ConnRef *connRef52 = ConnRef::createConnRef(router, 52).get();
    ...
    ConnRef *connRef53 = ConnRef::createConnRef(router, 53).get();
    ...
    ConnRef *connRef54 = ConnRef::createConnRef(router, 54).get();
