...
int main(void) {
    ...
    auto connRef20026701 = ConnRef::createConnRef(router, 20026701);
    ...
    auto connRef124776000 = ConnRef::createConnRef(router, 124776000);
    ...
    auto connRef162425002 = ConnRef::createConnRef(router, 162425002);
    ...
    auto connRef445102866 = ConnRef::createConnRef(router, 445102866);
    ...
    auto connRef472520508 = ConnRef::createConnRef(router, 472520508);
    ...
    auto connRef406587600 = ConnRef::createConnRef(router, 406587600);
    ...
    auto connRef41657796 = ConnRef::createConnRef(router, 41657796);
