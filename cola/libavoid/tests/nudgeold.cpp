...
int main(void) {
    ...
    ShapeRef::createShapeRef(router, poly426345871, 426345871);
    ...
    ShapeRef::createShapeRef(router, poly596896212, 596896212);
    
    ConnRef *connRef20026701 = ConnRef::createConnRef(router, 20026701).get();
    ...
    ConnRef *connRef124776000 = ConnRef::createConnRef(router, 124776000).get();
    ...
    ConnRef *connRef162425002 = ConnRef::createConnRef(router, 162425002).get();
    ...
    ConnRef *connRef445102866 = ConnRef::createConnRef(router, 445102866).get();
    ...
    ConnRef *connRef472520508 = ConnRef::createConnRef(router, 472520508).get();
    ...
    ConnRef *connRef406587600 = ConnRef::createConnRef(router, 406587600).get();
    ...
    ConnRef *connRef41657796 = ConnRef::createConnRef(router, 41657796).get();
