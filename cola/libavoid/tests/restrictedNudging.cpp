...
int main(void) {
    ...
    auto connRef355676284 = ConnRef::createConnRef(router, 355676284);
    ...
    auto connRef33653259 = ConnRef::createConnRef(router, 33653259);
    ...
    auto connRef421608980 = ConnRef::createConnRef(router, 421608980);
