...
int main(void) {
    ...
    */
    ...
    shapeRef1->createConnectionPin(102, 0.5, 1, true, 10, (ConnDirFlags) 2);
    ...
    shapeRef2->createConnectionPin(102, 0, 0.5, true, 10, (ConnDirFlags) 4);
    ...
    shapeRef3->createConnectionPin(102, 1, 0.5, true, 10, (ConnDirFlags) 8);
    ...
    shapeRef5->createConnectionPin(102, 0.5, 1, true, 10, (ConnDirFlags) 2);
    ...
    shapeRef7->createConnectionPin(102, 0.5, 1, true, 10, (ConnDirFlags) 2);
    ...
    shapeRef10->createConnectionPin(102, 0.5, 1, true, 10, (ConnDirFlags) 2);
