...
int main(void) {
    ...
    ShapeRef::createShapeRef(router, rect901116812, 901116812);
    ...
    ShapeRef::createShapeRef(router, rect448725420, 448725420);
    Rectangle rect74263573(Point(51900, 49750), Point(52300, 50100));
    ShapeRef::createShapeRef(router, rect74263573, 74263573);
    ...
    ConnRef::createConnRef(router, srcPt29344262, dstPt29344262, 29344262);
    ConnRef::createConnRef(router, srcPt45398340, dstPt45398340, 45398340);
    ConnRef::createConnRef(router, srcPt144520410, dstPt144520410, 144520410);
    ConnRef::createConnRef(router, srcPt463223880, dstPt463223880, 463223880);
